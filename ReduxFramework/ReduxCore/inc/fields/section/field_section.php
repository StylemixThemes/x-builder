            ...
            public function render() {
                ...
                <script type="text/javascript">
                    jQuery( document ).ready(
                        function() {
                            jQuery( '#<?php echo stm_x_filtered_output($this->field['id']); ?>-marker' ).parents( 'tr:first' ).css( {display: 'none'} ).prev('tr' ).css('border-bottom','none');;
                            var group = jQuery( '#<?php echo stm_x_filtered_output($this->field['id']); ?>-marker' ).parents( '.redux-group-tab:first' );
