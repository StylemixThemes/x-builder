...
let map = '';
let latlng = '';
let default_marker_icon = 'https://via.placeholder.com/1x1';
...
function initMap(e) {
    ...
    $('.x_gmap').each(function () {
        ...
        let zoom = parseFloat(window[module_id].zoom);

        let lat = parseFloat(window[module_id].lat);
        let lng = parseFloat(window[module_id].lng);

        let offset_x = (window[module_id].offset_x) ? parseFloat(window[module_id].offset_x) : 0;
        let offset_y = (window[module_id].offset_y) ? parseFloat(window[module_id].offset_y) : 0;
    ...
    google.maps.event.addListenerOnce(map, 'tilesloaded', function () {
        ...
        let $map_marker = $('body').find('img[src="' + default_marker_icon + '"]');
